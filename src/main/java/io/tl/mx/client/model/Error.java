...
public class Error {
  ...
  @ApiModelProperty(example = "400", value = "Codigo de Error.")
  ...
  @ApiModelProperty(example = "La fecha de nacimiento no tiene el formato correcto.", value = "Descripcion del error.")
