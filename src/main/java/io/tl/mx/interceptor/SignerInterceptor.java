...
import io.tl.mx.client.model.Error;
import io.tl.mx.client.model.RespuestaError;
...
public class SignerInterceptor implements Interceptor {
	...
	private RespuestaError errores = null;
	...
	private void setErrores(String payload) {
		...
		Gson gson = new Gson();
		this.errores = gson.fromJson(payload, RespuestaError.class);	
	}
	...
	private String generateError(String code, String message) {
		...
		RespuestaError errs = new RespuestaError();
		Error err = new Error();
		err.setCodigo(code);
